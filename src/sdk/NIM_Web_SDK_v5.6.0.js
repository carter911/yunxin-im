 ...
 */
        ...
        o.onSyncDone = function (e) {
            ...
            _.logger.info("sync::notifyDataAsync: onSyncDone", j && j.length);
            _.logger.info("sync::notifyDataAsync: result", N);
            ...
            function L() {
                _.logger.info("sync::onSyncDone: after sync", j ,  a.promises2cmds(j))
                ...
                if (j) {
                    ...
                    R && (c = function () {
                        ...
                        _.logger.info("sync::notifyDataAsync: get session",E.getSessions());
                        ...
                        R && !_.hasSynced && (_.hasSynced = !0, function () {
                            ...
                            t = E.getTeamMembersByAccount(_.account).then(function (e) {
                                ...
                                M = e
                                _.logger.info("sync::notifyDataAsync: get session2",e);
