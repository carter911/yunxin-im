...
Utils.formatMessage = function(message) {
  const maxLen = 20
  const haystack = message.toString()
...
Utils.formatRole = function (role) {
  var auth = {
    1 : '店面经理', 2 : '项目管家', 3 : '设计师',
    4 : '内部员工', 5 : '业主', 6 : '观察者',
    7 : '副业主', 8 : '工程部经理', 9 : '质检员',
    11 : '工班长', 12 : '行政部',
    13 : '行政部(客户)', 14 : '行政部（施工）', 15 : '主材经理', 16 : '辅材经理',
    17 : '主材供应商', 18 : '主材安装工', 19 : '软装经理', 20 : '主材供应商(甲供)', 21 : '主材安装工(甲供)',
  };
  return auth[role];
}
