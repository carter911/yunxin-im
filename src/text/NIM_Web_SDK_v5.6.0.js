    ...
    return function (e) {
        ...
        (function (e) {
            ...
            t.getGlobal = o, t.detectCSSFeature = function (e) {
                ...
                return "error" === v(e)
            }, t.isnull = S, t.notnull = C, t.undef = P, t.notundef = I, t.exist = O, t.notexist = x, t.isObject = w, t.isEmpty = function (e) {
            ...
            }, t.forOwn = F, t.mixin = j, t.isJSON = U, t.parseJSON = function e(t) {
                try {
                    U(t) && (t = JSON.parse(t)), w(t) && F(t, function (n, r) {
                        switch (v(r)) {
                            case"string":
                            case"object":
                                t[n] = e(r)
            ...
            function D(e, t, n) {
                ...
                return F(e, function (e, t) {
                    T(t) || (k(t) ? t = t.getTime() : M(t) ? t = t.join(",") : w(t) && (t = JSON.stringify(t)), n && (t = encodeURIComponent(t)), r.push(encodeURIComponent(e) + "=" + t))
                }), r.join(t || ",")
            }
            ...
            var o = function () {
                ...
                return function t(n) {
                    ...
                    var h, y, v, b, M,
                        ...
                        I = /\bJava/.test(C) && s.java, O = I && m(s.environment) == S, x = I ? "a" : "α",
                        w = I ? "b" : "β", A = s.document || {}, _ = s.operamini || s.opera,
                        E = r.test(E = o && _ ? _["[[Class]]"] : m(_)) ? E : _ = null, R = n, F = [], j = null,
                        N = n == g, U = N && _ && "function" == typeof _.version && _.version(),
                    ...
                    if (D && (D = [D]), q && !B && (B = W([q])), (h = /\bGoogle TV\b/.exec(B)) && (B = h[0]), /\bSimulator\b/i.test(n) && (B = (B ? B + " " : "") + "Simulator"), "Opera Mini" == L && /\bOPiOS\b/.test(n) && F.push("running in Turbo/Uncompressed mode"), "IE" == L && /\blike iPhone OS\b/.test(n) ? (q = (h = t(n.replace(/like iPhone OS/, ""))).manufacturer, B = h.product) : /^iP/.test(B) ? (L || (L = "Safari"), H = "iOS" + ((h = / OS ([\d_]+)/i.exec(n)) ? " " + h[1].replace(/_/g, ".") : "")) : "Konqueror" != L || /buntu/i.test(H) ? q && "Google" != q && (/Chrome/.test(L) && !/\bMobile Safari\b/i.test(n) || /\bVita\b/.test(B)) || /\bAndroid\b/.test(H) && /^Chrome/.test(L) && /\bVersion\//i.test(n) ? (L = "Android Browser", H = /\bAndroid\b/.test(H) ? H : "Android") : "Silk" == L ? (/\bMobi/i.test(n) || (H = "Android", F.unshift("desktop mode")), /Accelerated *= *true/i.test(n) && F.unshift("accelerated")) : "PaleMoon" == L && (h = /\bFirefox\/([\d.]+)\b/.exec(n)) ? F.push("identifying as Firefox " + h[1]) : "Firefox" == L && (h = /\b(Mobile|Tablet|TV)\b/i.exec(n)) ? (H || (H = "Firefox OS"), B || (B = h[1])) : !L || (h = !/\bMinefield\b/i.test(n) && /\b(?:Firefox|Safari)\b/.exec(L)) ? (L && !B && /[\/,]|^[^(]+?\)/.test(n.slice(n.indexOf(h + "/") + 8)) && (L = null), (h = B || q || H) && (B || q || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(H)) && (L = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(H) ? H : h) + " Browser")) : "Electron" == L && (h = (/\bChrome\/([\d.]+)\b/.exec(n) || 0)[1]) && F.push("Chromium " + h) : H = "Kubuntu", U || (U = p(["(?:Cloud9|CriOS|CrMo|Edge|FxiOS|IEMobile|Iron|Opera ?Mini|OPiOS|OPR|Raven|SamsungBrowser|Silk(?!/[\\d.]+$))", "Version", d(L), "(?:Firefox|Minefield|NetFront)"], function (e, t) {
                        ...
                        if (b = "global", M = null != (v = s) ? (0, i.default)(v[b]) : "number", /^(?:boolean|number|string|undefined)$/.test(M) || "object" == M && !v[b]) m(h = s.runtime) == k ? (L = "Adobe AIR", H = h.flash.system.Capabilities.os) : m(h = s.phantom) == P ? (L = "PhantomJS", U = (h = h.version || null) && h.major + "." + h.minor + "." + h.patch) : "number" == typeof A.documentMode && (h = /\bTrident\/(\d+)/i.exec(n)) ? (U = [U, A.documentMode], (h = +h[1] + 4) != U[1] && (F.push("IE " + U[1] + " mode"), D && (D[1] = ""), U[1] = h), U = "IE" == L ? String(U[1].toFixed(1)) : U[0]) : "number" == typeof A.documentMode && /^(?:Chrome|Firefox)\b/.test(L) && (F.push("masking as " + L + " " + U), L = "IE", U = "11.0", D = ["Trident"], H = "Windows"); else if (I && (R = (h = I.lang.System).getProperty("os.arch"), H = H || h.getProperty("os.name") + " " + h.getProperty("os.version")), O) {
                            ...
                            L || (L = "Rhino")
                        } else "object" === (0, i.default)(s.process) && !s.process.browser && (h = s.process) && ("object" === (0, i.default)(h.versions) && ("string" == typeof h.versions.electron ? (F.push("Node " + h.versions.node), L = "Electron", U = h.versions.electron) : "string" == typeof h.versions.nw && (F.push("Chromium " + U, "Node " + h.versions.node), L = "NW.js", U = h.versions.nw)), L || (L = "Node.js", R = h.arch, H = h.platform, U = (U = /[\d.]+/.exec(h.version)) ? U[0] : null));
                        H = H && u(H)
                    }
                    if (U && (h = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(U) || /(?:alpha|beta)(?: ?\d)?/i.exec(n + ";" + (N && c.appMinorVersion)) || /\bMinefield\b/i.test(n) && "a") && (j = /b/i.test(h) ? "beta" : "alpha", U = U.replace(RegExp(h + "\\+?$"), "") + ("beta" == j ? w : x) + (/\d+\+?/.exec(h) || "")), "Fennec" == L || "Firefox" == L && /\b(?:Android|Firefox OS)\b/.test(H)) L = "Firefox Mobile"; else if ("Maxthon" == L && U) U = U.replace(/\.[\d.]+/, ".x"); else if (/\bXbox\b/i.test(B)) "Xbox 360" == B && (H = null), "Xbox 360" == B && /\bIEMobile\b/.test(n) && F.unshift("mobile mode"); else if (!/^(?:Chrome|IE|Opera)$/.test(L) && (!L || B || /Browser|Mobi/.test(L)) || "Windows CE" != H && !/Mobi/i.test(n)) if ("IE" == L && N) try {
                        null === s.external && F.unshift("platform preview")
                    } catch (e) {
                        F.unshift("embedded")
                    } else (/\bBlackBerry\b/.test(B) || /\bBB10\b/.test(n)) && (h = (RegExp(B.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(n) || 0)[1] || U) ? (H = ((h = [h, /BB10/.test(n)])[1] ? (B = null, q = "BlackBerry") : "Device Software") + " " + h[0], U = null) : this != l && "Wii" != B && (N && _ || /Opera/.test(L) && /\b(?:MSIE|Firefox)\b/i.test(n) || "Firefox" == L && /\bOS X (?:\d+\.){2,}/.test(H) || "IE" == L && (H && !/^Win/.test(H) && U > 5.5 || /\bWindows XP\b/.test(H) && U > 8 || 8 == U && !/\bTrident\b/.test(n))) && !r.test(h = t.call(l, n.replace(r, "") + ";")) && h.name && (h = "ing as " + h.name + ((h = h.version) ? " " + h : ""), r.test(L) ? (/\bIE\b/.test(h) && "Mac OS" == H && (H = null), h = "identify" + h) : (h = "mask" + h, L = E ? u(E.replace(/([a-z])([A-Z])/g, "$1 $2")) : "Opera", /\bIE\b/.test(h) && (H = null), N || (U = null)), D = ["Presto"], F.push(h)); else L += " Mobile";
                    (h = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(n) || 0)[1]) && (h = [parseFloat(h.replace(/\.(\d)$/, ".0$1")), h], "Safari" == L && "+" == h[1].slice(-1) ? (L = "WebKit Nightly", j = "alpha", U = h[1].slice(0, -1)) : U != h[1] && U != (h[2] = (/\bSafari\/([\d.]+\+?)/i.exec(n) || 0)[1]) || (U = null), h[1] = (/\bChrome\/([\d.]+)/i.exec(n) || 0)[1], 537.36 == h[0] && 537.36 == h[2] && parseFloat(h[1]) >= 28 && "WebKit" == D && (D = ["Blink"]), N && (T || h[1]) ? (D && (D[1] = "like Chrome"), h = h[1] || ((h = h[0]) < 530 ? 1 : h < 532 ? 2 : h < 532.05 ? 3 : h < 533 ? 4 : h < 534.03 ? 5 : h < 534.07 ? 6 : h < 534.1 ? 7 : h < 534.13 ? 8 : h < 534.16 ? 9 : h < 534.24 ? 10 : h < 534.3 ? 11 : h < 535.01 ? 12 : h < 535.02 ? "13+" : h < 535.07 ? 15 : h < 535.11 ? 16 : h < 535.19 ? 17 : h < 536.05 ? 18 : h < 536.1 ? 19 : h < 537.01 ? 20 : h < 537.11 ? "21+" : h < 537.13 ? 23 : h < 537.18 ? 24 : h < 537.24 ? 25 : h < 537.36 ? 26 : "Blink" != D ? "27" : "28")) : (D && (D[1] = "like Safari"), h = (h = h[0]) < 400 ? 1 : h < 500 ? 2 : h < 526 ? 3 : h < 533 ? 4 : h < 534 ? "4+" : h < 535 ? 5 : h < 537 ? 6 : h < 538 ? 7 : h < 601 ? 8 : "8"), D && (D[1] += " " + (h += "number" == typeof h ? ".x" : /[.+]/.test(h) ? "" : "+")), "Safari" == L && (!U || parseInt(U) > 45) && (U = h)), "Opera" == L && (h = /\bzbov|zvav$/.exec(H)) ? (L += " ", F.unshift("desktop mode"), "zvav" == h ? (L += "Mini", U = null) : L += "Mobile", H = H.replace(RegExp(" *" + h + "$"), "")) : "Safari" == L && /\bChrome\b/.exec(D && D[1]) && (F.unshift("desktop mode"), L = "Chrome Mobile", U = null, /\bOS X\b/.test(H) ? (q = "Apple", H = "iOS 4.3+") : H = null), U && 0 == U.indexOf(h = /[\d.]+$/.exec(H)) && n.indexOf("/" + h + "-") > -1 && (H = f(H.replace(h, ""))), D && !/\b(?:Avant|Nook)\b/.test(L) && (/Browser|Lunascape|Maxthon/.test(L) || "Safari" != L && /^iOS/.test(H) && /\bSafari\b/.test(D[1]) || /^(?:Adobe|Arora|Breach|Midori|Opera|Phantom|Rekonq|Rock|Samsung Internet|Sleipnir|Web)/.test(L) && D[1]) && (h = D[D.length - 1]) && F.push(h), F.length && (F = ["(" + F.join("; ") + ")"]), q && B && B.indexOf(q) < 0 && F.push("on " + q), B && F.push((/^on /.test(F[F.length - 1]) ? "" : "on ") + B), H && (h = / ([\d.+]+)$/.exec(H), y = h && "/" == H.charAt(H.length - h[0].length - 1), H = {
                        architecture: 32,
                    ...
                    }), (h = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(R)) && !/\bi686\b/i.test(R) ? (H && (H.architecture = 64, H.family = H.family.replace(RegExp(" *" + h), "")), L && (/\bWOW64\b/i.test(n) || N && /\w(?:86|32)$/.test(c.cpuClass || c.platform) && !/\bWin64; x64\b/i.test(n)) && F.unshift("32-bit")) : H && /^OS X/.test(H.family) && "Chrome" == L && parseFloat(U) >= 39 && (H.architecture = 64), n || (n = null);
                    var J = {};
                    return J.description = n, J.layout = D && D[0], J.manufacturer = q, J.name = L, J.prerelease = j, J.product = B, J.ua = n, J.version = L && U, J.os = H || {
                        architecture: null,
                        family: null,
                        version: null,
                        toString: function () {
                    ...
                    }, J.version && F.unshift(U), J.name && F.unshift(L), H && L && (H != String(H).split(" ")[0] || H != L.split(" ")[0] && !B) && F.push(B ? "(" + H + ")" : "on " + H), F.length && (J.description = F.join(" ")), J
                }()
            }();
            e.exports = o
        }).call(this, n(30))
        ...
        "use strict";
        var r = n(34), s = n(16), i = n(60), o = n(19), a = n(23), c = n(105), u = n(33), l = n(74),
            m = n(5)("iterator"), d = !([].keys && "next" in [].keys()), p = function () {
                return this
            };
        e.exports = function (e, t, n, f, g, h, y) {
            ...
            var v, b, M, T = function (e) {
                ...
                }, k = t + " Iterator", S = "values" == g, C = !1, P = e.prototype,
                I = P[m] || P["@@iterator"] || g && P[g], O = I || T(g), x = g ? S ? T("entries") : O : void 0,
                w = "Array" == t && P.entries || I;
            if (w && (M = l(w.call(new e))) !== Object.prototype && M.next && (u(M, k, !0), r || "function" == typeof M[m] || o(M, m, p)), S && I && "values" !== I.name && (C = !0, O = function () {
                    return I.call(this)
                }), r && !y || !d && !C && P[m] || o(P, m, O), a[t] = O, a[k] = p, g) if (v = {
                    values: S ? O : T("values"),
                    keys: h ? O : T("keys"),
                    entries: x
        ...
        var a = n(0), c = a.notundef, u = a.exist, l = n(116), m = n(177), d = m.typeMap;
        ...
        "use strict";
        var r = n(7), s = n(13), i = n(14), o = n(16), a = n(60), c = n(95).KEY, u = n(20), l = n(40), m = n(33),
            d = n(28), p = n(5), f = n(38), g = n(37), h = n(94), y = n(93), v = n(15), b = n(18), M = n(17), T = n(42),
            k = n(26), S = n(47), C = n(92), P = n(56), I = n(12), O = n(29), x = P.f, w = I.f, A = C.f, _ = r.Symbol,
            E = r.JSON, R = E && E.stringify, F = p("_hidden"), j = p("toPrimitive"), N = {}.propertyIsEnumerable,
            U = l("symbol-registry"), D = l("symbols"), L = l("op-symbols"), B = Object.prototype,
            ...
            J = i && u(function () {
                ...
                return e === B && K(L, t, n), v(e), t = T(t, !0), v(n), s(D, t) ? (n.enumerable ? (s(e, F) && e[F][t] && (e[F][t] = !1), n = S(n, {enumerable: k(0, !1)})) : (s(e, F) || w(e, F, k(1, {})), e[F][t] = !0), J(e, t, n)) : w(e, t, n)
            }, X = function (e, t) {
                v(e);
                for (var n, r = h(t = M(t)), s = 0, i = r.length; i > s;) K(e, n = r[s++], t[n]);
                return e
            }, z = function (e) {
        ...
        q || (a((_ = function () {
            ...
            var e = d(arguments.length > 0 ? arguments[0] : void 0), t = function (n) {
                this === B && t.call(L, n), s(this, F) && s(this[F], e) && (this[F][e] = !1), J(this, e, k(1, n))
            };
            return i && W && J(B, e, {configurable: !0, set: t}), $(e)
        }).prototype, "toString", function () {
            return this._k
        }), P.f = G, I.f = K, n(57).f = C.f = Y, n(27).f = z, n(36).f = Q, i && !n(34) && a(B, "propertyIsEnumerable", z, !0), f.f = function (e) {
            return $(p(e))
        ...
        "use strict";
        var r = n(66), s = n(0), i = s.undef, o = s.notundef, a = n(8), c = n(82).getInstance("Chatroom"), u = n(233),
            l = n(168);
        ...
        }, e.exports = m, n(425), n(424), n(423), n(422)
    }, function (e, t, n) {
        "use strict";
        var r = n(0);
        ...
        var c = n(419), u = n(418), l = n(417)
    }, function (e, t, n) {
        "use strict";
        var r = n(49), s = n(113), i = n(8), o = n(233), a = n(421), c = n(0), u = c.verifyOptions,
            l = c.verifyParamType, m = n(82).getInstance("Chatroom");
 ...
 */
        ...
        "use strict";
        var r = n(79), s = n(0), i = s.notundef, o = {"-1": "restricted", 0: "common", 1: "owner", 2: "manager"};
        ...
        }, a.validTypes = Object.keys(o), e.exports = a
    }, function (e, t, n) {
        "use strict";
 ...
 */
            ...
            r = function () {
                ...
                function A(t, n, r) {
                    n.constructor === t.constructor && r === T && n.constructor.resolve === k ? function (e, t) {
                        t._state === I ? R(e, t._result) : t._state === O ? F(e, t._result) : j(t, void 0, function (t) {
                            return _(e, t)
                        }, function (t) {
                            return F(e, t)
                        })
                    }(t, n) : r === x ? (F(t, x.error), x.error = null) : void 0 === r ? R(t, n) : e(r) ? function (e, t, n) {
                        a(function (e) {
                ...
                function _(e, t) {
                    var n, r;
                    e === t ? F(e, new TypeError("You cannot resolve a promise with itself")) : (r = typeof(n = t), null === n || "object" !== r && "function" !== r ? R(e, t) : A(e, t, w(t)))
                }
                ...
                function U(t, n, r, s) {
                    ...
                    if (i) {
                        if ((o = function (e, t) {
                            ...
                            }(r, s)) === x ? (u = !0, a = o.error, o.error = null) : c = !0, n === o) return void F(n, new TypeError("A promises callback cannot return that same promise."))
                    } else o = s, c = !0;
                    n._state !== P || (i && c ? _(n, o) : u ? F(n, a) : t === I ? R(n, o) : t === O && F(n, o))
                }
                ...
                var B = function () {
                    function e(e, t) {
                        this._instanceConstructor = e, this.promise = new e(C), this.promise[S] || L(this.promise), r(t) ? (this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? R(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(t), 0 === this._remaining && R(this.promise, this._result))) : F(this.promise, new Error("Array Methods must be provided an Array"))
                    }
                    ...
                    return e.prototype._enumerate = function (e) {
                        ...
                        var r = this.promise;
                        r._state === P && (this._remaining--, e === O ? F(r, n) : this._result[t] = n), 0 === this._remaining && R(r, this._result)
                ...
                var q = function () {
                    function e(t) {
                        this[S] = D++, this._result = this._state = void 0, this._subscribers = [], C !== t && ("function" != typeof t && function () {
        ...
        i.transDoc = function (e) {
            ...
            var o = JSON.stringify(a.genResponseBody("file") || {}).replace(/"/gi, '\\"'), u = {
                transToken: {
                    name: n,
                    type: r[i],
        ...
        "use strict";
        var r = n(70), s = n(0), i = {welcome: "00", text: "01", link: "03"},
        ...
        var r = n(0), s = function (e) {
            ...
            }, i = s.prototype, o = i.Message = n(70), a = i.TextMessage = n(420), c = i.FileMessage = n(128),
            u = i.GeoMessage = n(416), l = i.NotificationMessage = n(415), m = i.CustomMessage = n(414),
            d = i.TipMessage = n(413), p = i.RobotMessage = n(412);
        ...
        "use strict";
        n(113).fn.refreshSocketUrl = function () {
        ...
        o.beforeSync = function () {
            ...
            var t, n, r, s, o, f, g, h, y, v, b, M, T, k, S, C, P, I, O, x, w, A, _ = this, E = _.db, R = E.enable,
                F = _.options, j = _.syncPromiseArray, N = _.syncResult;
            if (j && j.length) {
                var U = j.filter(function (e) {
            ...
            function L() {
                if (j) {
                    if (_.logger.info("sync::onSyncDone: after sync", a.promises2cmds(j)), j = [], n = N.blacklist || [], r = N.invalidBlacklist || [], s = N.mutelist || [], o = N.invalidMutelist || [], f = N.friends, g = N.invalidFriends || [], h = N.myInfo, y = N.users, v = N.teams, b = N.invalidTeams || [], M = N.sessions, T = N.msgReceipts, k = N.roamingMsgs, S = N.offlineMsgs, C = N.offlineFilterMsgs, I = N.offlineSysMsgs, O = N.offlineCustomSysMsgs, x = N.offlineFilterSysMsgs, w = N.offlineFilterCustomSysMsgs, N.broadcastMsgs, A = N.sysMsgUnread, M) {
                        var e = [];
            ...
            function H() {
                _.logger.info("sync::notifyDataAsync: M" , M);

                var e, t, r = [];
                n && (_.logger.info("sync::notifyDataAsync: on blacklist", m(n), n), F.onblacklist(n)), s && (_.logger.info("sync::notifyDataAsync: on mutelist", m(s), s), F.onmutelist(s)), f && (_.logger.info("sync::notifyDataAsync: on friends", m(f), f), F.onfriends(f)), h && (_.logger.info("sync::notifyDataAsync: on myInfo", h), _.myInfo = h, F.onmyinfo(a.copy(h))),


                y && (y.forEach(function (e) {_.mergeUser(e)}),
                      _.logger.info("sync::notifyDataAsync: on users", m(y), y),
                      F.onusers(y)),

                v && (_.logger.info("sync::notifyDataAsync: on teams", d(v), v), F.onteams(v)),
                T && (!_.hasSynced && M && M.length || _.hasSynced) &&
                (M = _.mergeSessionAndMsgReceipts(M, T)), M && M.length && (M.forEach(function (e) {
                    ...
                    _.logger.info("sync::notifyDataAsync: start"),
                ...
                }), i.length && (P = (P = P || []).concat(i)), o.length && (I = (I = I || []).concat(o)), P && (_.logger.info("sync::notifyDataAsync: on roaming sys msgs", P.length, P), F.onroamingsysmsgs(P)), I && (_.logger.info("sync::notifyDataAsync: on offline sys msgs", I.length, I), F.onofflinesysmsgs(I)), x && (_.logger.info("sync::notifyDataAsync: on offline filter sys msgs", x.length, x), F.onofflinefiltersysmsgs(x)), O && (_.logger.info("sync::notifyDataAsync: on offline custom sys msgs", O.length, O), F.onofflinecustomsysmsgs(O)), w && (_.logger.info("sync::notifyDataAsync: on offline filter custom sys msgs", w.length, w), F.onofflinefiltercustomsysmsgs(w)), A && (A = a.merge({}, _.sysMsgUnread, A), _.sysMsgUnread = a.merge({}, A), _.logger.info("sync::notifyDataAsync: on sysMsgUnread", A), F.onsysmsgunread(A));
                        ...
                        var r = this, s = !1, i = !1, o = function (r, o, c, d, p, f, g) {
                            return new Promise(function (y, v) {
                                var b = s || i ? m : l, M = t.transaction(e, b), T = M.objectStore(e),
                                    k = n ? T.index(n) : T, S = r ? u[r].apply(null, o) : null, C = [], P = [S], I = 0;
        ...
        "use strict";
        n(141);
        var r = {NIM: n(492), Chatroom: n(426)};
        n(169)(r), e.exports = r
    }])
});